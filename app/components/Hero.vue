<template>
  <section
    id="home"
    class="relative min-h-[calc(100vh-80px)] overflow-hidden pt-20 lg:pt-16"
  >
    <div
    ...
    >
      ...
      <div class="relative z-10 max-w-2xl">
        ...
        >
          I design thoughtful interfaces and bring them to life
          through clean, responsive, and engaging frontend
          development.
        </p>
